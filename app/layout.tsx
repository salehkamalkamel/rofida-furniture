...
export const metadata: Metadata = {
  ...
  description:
    "روفيدا للأثاث بتقدّم أثاث عصري بتصميمات أنيقة وجودة عالية وأسعار تنافسية جدًا. شحن لجميع أنحاء مصر ، مع ضمان على جميع المنتجات.",
  keywords: [
    "روفيدا للأثاث",
    "أثاث عصري",
    "أثاث مودرن",
  ...
  return (
    <html lang="ar" dir="rtl">
      ...
      >
        {children}
        <Analytics />
        {/* Vercel Speed Insights component for performance monitoring and optimization */}
        <SpeedInsights />
        <Toaster />
      </body>
    </html>
