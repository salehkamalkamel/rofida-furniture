...
export const products: Product[] = [
  {
    ...
    fullDescription: "أريكة عصرية بتصميم اسكندنافي أنيق، مصنوعة من خشب البلوط الطبيعي مع قماش عالي الجودة مقاوم للبقع. توفر راحة استثنائية للجلوس لفترات طويلة مع وسائد داعمة للظهر.",
    price: 4999,
    originalPrice: 6499,
    discount: 23,
    images: [
  ...
  },
  {
    ...
    fullDescription: "طاولة قهوة أنيقة بتصميم بسيط ومعاصر. مصنوعة من خشب الجوز الصلب مع لمسة نهائية طبيعية تبرز جمال الخشب الطبيعي.",
    price: 1299,
    images: [
  ...
  },
  {
    ...
    fullDescription: "كرسي طعام مريح بتصميم اسكندنافي كلاسيكي. الهيكل من خشب الزان المتين والمقعد مبطن بقماش ناعم للراحة القصوى.",
    price: 599,
    originalPrice: 799,
    discount: 25,
    images: [
  ...
  },
  {
    ...
    fullDescription: "سرير فاخر بتصميم عصري أنيق. يتميز بلوح رأسي مبطن بقماش مخملي ناعم وقاعدة من خشب الصنوبر المعالج.",
    price: 3499,
    images: [
  ...
  },
  {
    ...
    fullDescription: "مكتب عمل عملي وأنيق مثالي للمكتب المنزلي. يحتوي على درجين للتخزين وسطح عمل واسع.",
    price: 1899,
    originalPrice: 2299,
    discount: 17,
    images: [
  ...
  },
  {
    ...
    fullDescription: "ستصبح دعاسة الحمام المصنوعة من القطن الخالص باللون الرمادي الغامق هي المفضلة لديك بسهولة. يقوم نسيجها بتدليك قدميك ويجف سريعاً.",
    price: 599,
    originalPrice: 799,
    discount: 25,
    images: [
  ...
  },
  {
    ...
    fullDescription: "مصباح أرضي أنيق بتصميم عصري. القاعدة من المعدن بلمسة نحاسية والغطاء من القماش الأبيض الناعم.",
    price: 899,
    images: [
  ...
  },
  {
    ...
    fullDescription: "خزانة ملابس واسعة بتصميم بسيط وعملي. تحتوي على رفوف قابلة للتعديل وقضيب للتعليق.",
    price: 2799,
    originalPrice: 3299,
    discount: 15,
    images: [
  ...
  },
  {
    ...
    fullDescription: "كرسي حديقة مريح مصنوع من خشب الأكاسيا المعالج للاستخدام الخارجي. مقاوم للعوامل الجوية.",
    price: 799,
    images: [
  ...
  },
  {
    ...
    fullDescription: "طاولة طعام فاخرة من خشب البلوط الصلب بتصميم اسكندنافي كلاسيكي. تتسع لـ 6 أشخاص بشكل مريح.",
    price: 3999,
    originalPrice: 4799,
    discount: 17,
    images: [
  ...
  },
  {
    ...
    fullDescription: "كومود أنيق بثلاثة أدراج واسعة. يجمع بين اللون الأبيض النظيف وتفاصيل الخشب الطبيعي.",
    price: 1499,
    images: [
  ...
  },
  {
    ...
    fullDescription: "رف كتب عصري بخمس طبقات مفتوحة. تصميم صناعي أنيق يجمع بين المعدن الأسود والخشب.",
    price: 999,
    originalPrice: 1299,
    discount: 23,
    images: [
...
export const heroSlides = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=1600&h=800&fit=crop",
    cta: "اكتشف العروض",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?w=1600&h=800&fit=crop",
    cta: "استعرض المجموعة",
